...
export const authSigninMail = (address /* str */,password /* str */)=>_req(2,NULL,T2Encode([address,password]))
export const authSignupMail = (address /* str */,password /* str */)=>_req(3,NULL,T2Encode([address,password]))
